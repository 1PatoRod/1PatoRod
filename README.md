...
Most of my work from Oct 2024 to today lives in a private GitLab for the City of Córdoba government (DTEC) — high commit volume across multiple production systems: Mobility Permit Holders, Records Portal, MiDocta, Field Inspectors, and the Procurement portal. These repositories are private and not publicly visible. Government profile: https://git.dtec.cordoba.gov.ar/Pato
